...
\begin{document}
    ...
    \subsubsection{Вывод свидетельств}
    ...
    \footnote{Нужен импорт модуля, даже пустой, с определением нужных инстансов: \mintinline{haskell}|import Module ()|.}
    ...
    \footnote{\href{https://youtu.be/-TJGhGa04F8?si=vQDXYa3frYilXRhw}{(youtube) Type inference as constraint solving: how GHC’s type inference engine actually works - SPJ.}}
