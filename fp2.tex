...
\begin{document}
    ...
    % todo нормальное объяснение, откуда тут слово инициальный, что-то в статье про параметрический полиморфизм было
    ...
    % todo котлин и кепчуринг мутабельных штуки
    ...
    % todo accelerate & java code reflection
