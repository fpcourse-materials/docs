...
\begin{document}
    ...
    Такого подхода придерживаются JVM, Haskell и, как правило, другие функциональные языки.
    ...
    Языки со стиранием типов стараются снижать накладные расходы на боксинг.
    Так, некоторые языки урезают диапазоны значений примитивов для избежания боксинга, например, OCaml и \href{https://koka-lang.github.io/koka/doc/book.html#sec-value-types}{Koka}.
