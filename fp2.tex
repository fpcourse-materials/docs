...
\begin{document}
    ...
    % todo отдельная глава про DSL
    % todo deep vs shallow embedding: gibbons paper, https://github.com/dajhutchinson/Language-Engineering/tree/master
    ...
    % todo semantics by example & примеры спек промышленных языков
