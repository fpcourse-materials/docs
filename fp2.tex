...
\begin{document}
    ...
    \begin{center}
    {\LARGE ФП 2.0}
        \footnote{Автор Андрей Стоян (\texttt{andrey.stoyan.csam@gmail.com}).}\footnote{Особая благодарность Илье Колегову за внимательное прочтение и конструктивную критику.}
        \\
        осень 2025
    \end{center}
