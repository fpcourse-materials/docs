...
\begin{document}
    ...
    Семантика языков программирования --- это наука о том, как формально изучать поведение программ при исполнении, и как собственно описать, что значат те или иные конструкции в языке.
