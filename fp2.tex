...
\begin{document}
    ...
    Построим meta-circular tagless interpreter.



    \begin{minted}{haskell}
        data Term env ty where
          Var :: InCtx env ty -> Term env ty
          App :: Term env (arg -> res) -> Term env arg -> Term env res
          Lam :: (Term env arg -> Term env res) -> Term env (arg -> res)



        data InCtx env ty where
          Here :: Var (ty, env) ty
          There :: Var env ty -> Var (ty', env) ty
    \end{minted}

    \cite{kiselyov2012typed}

    % todo link to Oleg's notes
