...
\begin{document}
    ...
    В качестве основного языка курса выбран Haskell, так как он, с одной стороны, воплощает в себе многие продвинутые концепции, часто доведенные до некоторого логического завершения, и достаточно могуществен для кодирования других.
    ...
    \section{Типы и параметрический полиморфизм}
    ...
    \section{Алгебраические эффекты и хендлеры} \label{sec:effect-handlers}
