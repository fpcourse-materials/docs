...
%
%    Языки программирования своей изначальной целью имели упрощение взаимодействия человека и компьютера.
%    Человек должен с помощью компьютера решать свои задачи, а не заниматься нужными железу церемониями.
    ...
    \section{Интерпретаторы зазеркалья}
