...
\begin{document}
    ...
    \subsubsection{Инстанциация}

    \vocab{Инстанциирование} --- самый прямолинейный подход, компилируем функцию отдельно для каждого набора типовых аргументов.
    ...
    % todo эмуляция higher-kinded plymorphism через дефункционализацию
