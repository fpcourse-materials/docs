...
\begin{document}
    ...
    \begin{center}
    {\LARGE ФП 2.0} % Спасибо моим студентам, которые своим интересом к предмету сделали эту работу возможной.
        \footnote{Автор Андрей Стоян (\texttt{andrey.stoyan.csam@gmail.com}).}\footnote{Спасибо Илье Колегову за первое внимательное прочтение и кучу комментариев.}\footnote{Версия от \today, \currenttime.}
        \\
        осень 2025
    \end{center}
