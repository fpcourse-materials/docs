...
\begin{document}
    ...
    \begin{frame}[fragile]{В предыдущих сериях}
        \begin{itemize}
            \item Полиморфные \mintinline{haskell}|data| и \mintinline{haskell}|type|
    ...
    \begin{frame}[fragile]{Абстрактный тип данных --- \mintinline{haskell}|Monad|}
        ...
        \begin{itemize}
            ...
            \item[\eg] \mintinline{haskell}|[]|, \mintinline{haskell}|Maybe|, \mintinline{haskell}|Either e|
            \item[\eg] \mintinline{haskell}|newtype State s a = State (s -> (a, s))|
