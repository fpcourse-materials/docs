...
Однако, можно определять тип данных и через способы его деконструировать с помощью ключевого слова \mintinline{haskell}{codata}.
Сконструировать такой тип данных можно с помощью co-pattern-matching'а.
