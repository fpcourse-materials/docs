...
Особенно сильно различия проявляются в асинхронном окружении (в этом случае работу с такими коллекциями называют \vocab{реактивным программированием}\footnote{\href{https://youtu.be/sTSQlYX5DU0?si=Xhfi62ScXHBBjdBx}{React 2014 : Erik Meijer - What does it mean to be Reactive?}}).
