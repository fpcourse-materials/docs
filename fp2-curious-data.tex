...
Особенно сильно различия проявляются в асинхронном окружении (в этом случае работу с такими коллекциями иногда называют \vocab{реактивным программированием}\footnote{\href{https://youtu.be/sTSQlYX5DU0?si=Xhfi62ScXHBBjdBx}{(youtube) React 2014 : Erik Meijer - What does it mean to be Reactive?}}).
Тут Church encoding соответствует \vocab{горячим потокам}, а co-Church encoding --- \vocab{холодным}.
