...
%    \end{frame}
    ...
    \begin{frame}[fragile]{Аппликативные функторы для вычислений над содержимым коробочек}
        ...
        \begin{itemize}
            ...
            \item[\eg] \mintinline{haskell}{Map.lookup :: k -> Map k v -> Maybe v}
        ...
        \begin{itemize}
            ...
            \begin{minted}{haskell}
                ...
                advantage db ids1 ids2 = liftA2 (<) (teamRank ids1) (teamRank ids2) where
                  teamRank = fmap (sumBy rank) . mapA (dbLookup db)
                  sumBy f = sum . map f
    ...
    \begin{frame}[fragile]{Идиома вычислений в аппликативном контексте}
        ...
        \begin{itemize}
            ...
            \item[\NB] Аппликативные функторы позволяют замести под ковёр неинтересную рутину и церемонии, оставив нас наедине с бизнес-логикой (в форме идиомы)
        \end{itemize}
    \end{frame}
    ...
    \begin{frame}[fragile]{Функции на типах}
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \item Получаем новый тип, эквивалентный (изоморфный) композиции
                \begin{minted}{haskell}
                    Compose f g a #$\sim$# f (g a)
                \end{minted}
