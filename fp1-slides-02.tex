...
\begin{document}
    ...
    \begin{frame}{Рекурсивные уравнения на термах}
        ...
        \begin{enumerate}
            ...
            \[
                \term{fac} \eqbeta \term{fac'} \ap \term{fac}
            \]
    ...
    \begin{frame}[fragile]{Выбор инструмента: примитивная рекурсия vs рекурсия \popslide}
        \begin{itemize}
    ...
    \begin{frame}[fragile]{Моделируем значения-варианты}
        ...
        \begin{block}{Законы вариантов}
            \begin{enumerate}
                ...
                \item $\forall f~g~y \ldotp \term{either} \ap f \ap g \ap (\term{inr} \ap x) \eqbeta g \ap y$
            \end{enumerate}
        \end{block}
        \pause
        \begin{itemize}
