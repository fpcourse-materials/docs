...
\vocab{Чистая функция}:

\vocab{Чистое вычисление} --- единственный его наблюдаемый результат --- его значение.
\vocab{Чистая функция} --- её результат всегда одинаков при одинаковом наборе аргументов и  хеё аппликация --- чистое вычисление.
...
Так, композиция чистых функций --- чистая функция; про программы можно рассуждать с помощью equational reasoning; всё, что нужно для понимания кода, явно написано в этом коде; классические системы типов хорошо работают, предоставляя полноту абстракции, качественную документацию и частичную спецификацию\ldots
