...
\begin{itemize}
    ...
    Реализация корутин поверх хендлеров даёт возможность пользователям писать собственные планировщики, что, на данный момент, самое котируемое применение хендлеров на данный момент~\cite{sivaramakrishnan2021retrofitting, phipps2023continuing}. % todo
\end{itemize}
