...
Можно считать, что семейства\footnote{\url{https://ghc.gitlab.haskell.org/ghc/doc/users_guide/exts/type_families.html}} --- это типовые конструкторы, задающие множество типов.
...
\cite{stolarek2015injective}

% todo there was something in levity

% todo

\subsubsection{Семейства первого класса}

\cite{defunctionalization-slides, eisenberg2014promoting}
\cite{kiss2019higher}

% todo fist-class type families, defunctionalisation (Eisenberg 2013)
