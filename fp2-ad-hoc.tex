...
Как мы увидим далее, неявные параметры сами по себе тоже нужны как статическая аппроксимация динамических свободных переменных для реализации системы эффектов. % todo ref
...
TODO % todo record fields, OverloadedLabels, scope resolve via overloading

\subsubsection{Несинтаксические типовые эквивалентности, System FC} \label{subsubsec:system-fc}

TODO % todo equality constraint и всё что через него выражается
...
Более того, статически типизированные ошибки это активная область исследований, будем говорить об этом в рамках систем эффектов. % todo ref
