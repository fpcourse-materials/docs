...
% todo algebra, laws and optimizations
...
Значение типа \mintinline{haskell}|Has| свидетельствует о том, что существует некоторый тип \texttt{a}, который принадлежит определённому классу типов.
