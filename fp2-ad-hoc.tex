...
% todo более плавное введение
% вот в Пирсе есть экзистенциальные типы, они о том
% мы же получаем их через полиморфизм и data
...
Однако, помимо значения, можно положить в структуру данных свидетельство о том, что этот неизвестный тип удовлетворяет некоторому классу типов\footnote{Подобно fat pointers в Rust.}.
\begin{minted}{haskell}
