...
И в завершение рассмотрим полиморфизм по рантайм-представлению (``полиморфизм по полиморфизму''). % todo можно ли это так назвать
...
Добавим типовой параметр, который будет говорить, в какой тип интерпретируется терм.
