...
Первая предпочтительна с точки зрения качества кода, однако вторая порождает промежуточный список во время работы:
\begin{minted}{haskell}
...
%
%% todo internal iteration vs external iteration
%
%TODO % todo
%
