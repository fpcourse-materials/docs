...
\begin{align*}
    ...
    \iso a^{\displaystyle a^{\displaystyle \left(a^{\displaystyle a^{\displaystyle elem}}\right)}} \\
...
Рассмотрим наш пример tagless initial encoding~\ref{subsubsec:tagless-initial}:
\begin{minted}{haskell}
    data Expr ty where
      Const :: Int -> Expr Int
