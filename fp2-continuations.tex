...
Также, можно фреймы представить в виде эндоморфизмов и в качестве ассоциативной операции использовать композицию функций\footnote{\url{https://wiki.haskell.org/Difference_list}}.
...
\subsubsection{Всё через продолжения}
...
Ошибки монадические и континуэйшеновые % todo
...
Раньше код был размазан по функциям с связыванию, теперь он в одном месте.
