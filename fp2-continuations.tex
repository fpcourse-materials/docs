...
\subsubsection{Денотационная семантика с продолжениями}
...
\subsubsection{Дефункционализация и аккумуляторы}
...
% todo continuation passing style, representing monads

% todo delimited continuations

% todo реализация продолжений

% todo приложения продолжений
