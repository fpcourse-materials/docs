...
Оказывается, что да\footnote{\url{http://www.schoolofhaskell.com/school/to-infinity-and-beyond/pick-of-the-week/the-mother-of-all-monads}}\footnote{\url{https://blog.poisson.chat/posts/2019-10-26-reasonable-continuations.html}}\footnote{\url{https://blog.poisson.chat/posts/2019-10-27-continuation-submonads.html}}~\cite{filinski1994representing}.


Универсально ли это для произвольной монады?


Конкретный представитель кепчурит идею целого класса.
И класс может определяться через представителя (representation theorem).

Такой Cont на самом деле трансформер.
...
% todo monads in python with nice syntax http://www.valuedlessons.com/2008/01/monads-in-python-with-nice-syntax.html
...
% todo https://blog.poisson.chat/posts/2019-10-27-continuation-submonads.html
