...
\subsubsection{Классификация} \label{subsubsec:delim-cont-classification}
...
\testtt{shift} просто захватывает текущее продолжение и передаёт его в пользовательское вычисление подобно \texttt{cont}:
\begin{minted}{haskell}
...
\subsection{Приложения продолжений}

\subsubsection{Всё через продолжения}

% todo

\subsubsection{The mother of all monads}
...
\subsection{Эффективная реализация продолжений}
